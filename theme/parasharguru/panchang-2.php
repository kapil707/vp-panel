...
function results() {
  ...
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"><tr bgcolor="#fcf8dd"><td width="20" height="20"><img src="<?php echo get_theme_path();?>/images/Bullet2.gif" width="20" height="20"></td><td width="20" height="20">';
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"><tr><td align="center" bgcolor="#999999" height="1"></td></tr><tr><td align="center" height="19"><span class="text3">&nbsp;<font color="#3DB679">Moon: </font>' + lon2dmsz(fix360(Lmoon + ayanamsa)) + '</span></td></tr></table></td><td width="20" height="20"><img src="<?php echo get_theme_path();?>/images/Bullet2.gif" width="20" height="20"></td></tr></table>';
  ...
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="20"><tr bgcolor="#fcf8dd"><td width="20" height="20"><img src="<?php echo get_theme_path();?>/images/Bullet2.gif" width="20" height="20"></td><td width="500" height="20">';
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"><tr><td align="center" height="19"><span class="text3"><font color="#3DB679">Ayanamsa: </font>' + lon2dms(ayanamsa) + '</span></td></tr><tr><td align="center" bgcolor="#999999" height="1"></td></tr></table></td><td width="20" height="20"><img src="<?php echo get_theme_path();?>/images/Bullet2.gif" width="20" height="20"></td></tr></table>';
