...
function check_password1()
{
	...
	if(new_password.length < 8)
	{
		...
		$(".alert_div").html("<p class='text-danger'>Password must contain 8 characters (e.g. A,a or 1,2 or !,$,@)</p>");
		// pass2 = 0;
		// submit_btn();
	}
	else
...
function check_password2()
{
	...
	if(new_password!=renew_password)
	{
		...
		$(".alert_div").html("<p class='text-danger'>Password doesn't match</p>");
		// pass3 = 0;
		// submit_btn();
	}
	else
	{
		$(".alert_div").html("<p class='text-success'>Password Matched.</p>");
		// pass3 = 1;
		// submit_btn();
	}
}
