...
<div>
	<p class="text-[#A17603] font-semibold text-center pt-2 px-4 text-[24px] my-3 leading-7">
		<?php echo get_field('login_label3','43'); ?>
	</p>
	<div class="flex justify-center items-center gap-4 mx-auto mt-3">
		...
		<p class="text-[#A17603] font-normal text-[22px]">
			<?php echo get_field('login_label4','43'); ?>
		</p>
	</div>
</div>
<p class="font-medium text-[#A17603] text-center">
	<?php echo get_field('login_label5','43'); ?>
</p>
...
<TABLE cellSpacing=0 cellPadding=0 width=500 align=center 
              ...
              <TR>
                <TD>
                  <DIV id=vvv align=center><FONT color=#800040><FONT 
                  face="sans-serif, serif">Please, 
              wait...</FONT></FONT></DIV></TD></TR></TBODY></TABLE>
            <FORM name=Form1>
            <TABLE cellSpacing=1 cellPadding=15 width="95%" align=center 
            border=0>
              <TBODY>
              <TR>
                <TD vAlign=top>
                  <DIV align=center>
                  <TABLE 
                  style="FONT-SIZE: larger; FONT-FAMILY: Courier New, Courier, mono" 
                  cellSpacing=1 borderColorDark=#5F5F5F cellPadding=3 
                  bgColor=#800040 borderColorLight=#EFEFEF border=0 width="314">
                    <TBODY>
                    <TR>
                      <TD bgColor=#FFCC00>Date:&nbsp;&nbsp;<INPUT id=fld 
                        maxLength=2 size=2 value=1 name=Day> <SELECT id=fld 
                        name=Month> <OPTION value=0 selected>January</OPTION> 
                          <OPTION value=1>February</OPTION> <OPTION 
                          value=2>March</OPTION> <OPTION value=3>April</OPTION> 
                          <OPTION value=4>May</OPTION> <OPTION 
                          value=5>June</OPTION> <OPTION value=6>July</OPTION> 
                          <OPTION value=7>August</OPTION> <OPTION 
                          value=8>September</OPTION> <OPTION 
                          value=9>October</OPTION> <OPTION 
                          value=10>November</OPTION> <OPTION 
                          value=11>December</OPTION></SELECT> 
						<INPUT id=fld 
                        maxLength=4 size=6 value=2002 name=Year> </TD></TR>
                    <TR>
                      <TD bgColor=#FFCC00>Time:&nbsp;&nbsp;<INPUT id=fld 
                        maxLength=2 size=2 value=0 name=Hours>:<INPUT id=fld 
                        maxLength=2 size=2 value=0 name=Minutes></TD></TR>
                    <TR>
                      <TD bgColor=#FFCC00>Zone:&nbsp;&nbsp;<INPUT id=fld 
                        maxLength=2 size=2 value=0 name=ZoneHour>:<INPUT id=fld 
                        maxLength=2 size=2 value=0 name=ZoneMin></TD></TR>
                    <TR>
                      <TD align=middle bgColor=#FFCC00><INPUT onclick=calculate() type=button value="Generate Panchang" name=Calculate></TD></TR></TBODY></TABLE></DIV></TD></TR></TBODY></TABLE></FORM>
            <BLOCKQUOTE>
              <P class=text5>Panchanga is the quality of the day, which consists of 
              five elements - Vara (Day), Tithi (Lunar Day), Nakshatra (Star), 
...
function results() {
  ...
  panch+='<table width="540" border="0" cellspacing="0" cellpadding="0" align="center"><tr bgcolor="#fcf8dd"><td width="20" height="20"><img src="Bullet2.gif" width="20" height="20"></td><td width="500" height="20">';
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"><tr><td align="center" bgcolor="#999999" height="1"></td></tr><tr><td align="center" height="19"><span class="text3">&nbsp;<font color="#3DB679">Moon: </font>' + lon2dmsz(fix360(Lmoon + ayanamsa)) + '</span></td></tr></table></td><td width="20" height="20"><img src="Bullet2.gif" width="20" height="20"></td></tr></table>';
  panch+='<table width="540" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#999999"><tr bgcolor="#fcf8dd"><td valign="middle" bgcolor="#fcf8dd" nowrap colspan="2"><font class="text3" color="#3DB679">Day:</font><br>';
  ...
  panch+='<table width="540" border="0" cellspacing="0" cellpadding="0" align="center" height="20"><tr bgcolor="#fcf8dd"><td width="20" height="20"><img src="Bullet2.gif" width="20" height="20"></td><td width="500" height="20">';
  panch+='<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"><tr><td align="center" height="19"><span class="text3"><font color="#3DB679">Ayanamsa: </font>' + lon2dms(ayanamsa) + '</span></td></tr><tr><td align="center" bgcolor="#999999" height="1"></td></tr></table></td><td width="20" height="20"><img src="Bullet2.gif" width="20" height="20"></td></tr></table>';
