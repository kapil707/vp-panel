...
class Construction_up extends CI_Controller {
	
	var $Page_title = "Construction Update";
	var $Page_name  = "construction Update";
	var $Page_view  = "construction_up";
	var $Page_menu  = "construction";
	var $page_controllers = "Construction_up";
	...
	public function index()
	{
		...
		// $data['id'] = $id;
		$data['id'] = $id = "Central Market Construction Update";
		$cat = str_replace("-"," ",$id);
		...
		$this->load->view("website/construction_up",$data);
