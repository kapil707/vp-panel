...
class Manage_social_icon extends CI_Controller {
	var $Page_title = "Manage Social Icon";
	var $Page_name  = "manage_social_icon";
	var $Page_view  = "manage_social_icon";
	var $Page_menu  = "manage_social_icon";
	var $page_controllers = "manage_social_icon";
	...
	public function view()
	{
		...
		$page_type = "social_icon";
		$query = $this->db->query("select * from $tbl where page_type='$page_type' order by sorting_order asc");
