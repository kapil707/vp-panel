...
class Manage_gallery extends CI_Controller {
	...
	public function check_url_api()
	{
		...
		$query = $this->db->query("select id from $Page_tbl where url='$url' and child_page='$child_page' and page_type='gallery' $where")->row();
		if($query->id)
		{
			echo "Error";
		}
	...
	public function check_sorting_order_api()
	{
		...
		$query = $this->db->query("select id from $Page_tbl where sorting_order='$sorting_order' and child_page='$child_page' and page_type='gallery' $where")->row();
		if($query->id)
		{
			echo "Error";
		}
	...
	public function setting()
	{
		...
		if(isset($Submit))
		{
			...
			$this->Manage_field_group_model->insert_field_data_default($gallery_page_number,"gallery_page_number");
