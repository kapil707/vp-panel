				...
				<?php if($get_child_page==$menu_page_type && $get_child_page!="") { ?> class="active" <?php } ?>>
					...
					<ul class="nav nav-second-level collapse">
						<?php if($mymenu->page_add=="1"){ ?>
								<li <?php if($Page_menu=="title") { ?> class="active" <?php } ?>><a href="<?= base_url()?>admin/<?php echo $menu_add_url ?>">Add</a></li>
						<?php } ?>
						<?php if($mymenu->page_view=="1"){ ?>
								<li <?php if($Page_menu=="title") { ?> class="active" <?php } ?>><a href="<?= base_url()?>admin/<?php echo $menu_url ?>">View</a></li>
						<?php } ?>
