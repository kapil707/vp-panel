			...
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control" id="form-field-1" placeholder="Icon" name="description" value="<?php echo str_replace('"',"'",$row->description); ?>" />
						</div>
						<div class="help-inline col-sm-12 has-error">
							<span class="help-block reset middle">  
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control" id="form-field-1" placeholder="Url" name="url" value="<?php echo $row->url; ?>" />
						</div>
						<div class="help-inline col-sm-12 has-error">
							<span class="help-block reset middle">  
								<?= form_error('url'); ?>
