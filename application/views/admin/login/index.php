...
<html lang="en">
	<head>
        ...
        <link rel="shortcut icon" href="<?= base_url()?>/uploads/manage_website/photo/<?= $this->Main_Model->get_website_data("icon") ;?>" type="image/x-icon">
        <link rel="icon" href="<?= base_url()?>/uploads/manage_website/photo/<?= $this->Main_Model->get_website_data("icon") ;?>" type="image/x-icon">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
				<img alt="image" class="img-circle" src="<?= base_url()?>assets/admin/vp-admin.png" width="300" />
