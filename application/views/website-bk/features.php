...
$banner = $this->Main_Model->get_website_data("features_banner");
$features = $this->Main_Model->get_website_data("features");
?>
...
<div class="container-fluid cnt_fluid_wrapper">
	<div class="bread_block" id="bread_height_js">
		<div class="page_ttl_bread">Features</div>
		<div class="page_menu_bread">
		<a href="<?php echo base_url(); ?>">Home</a><span class='bread_arrow'>&#8250;</span>Features
		</div>			
	</div>
			...
			<div class="msection-contant">
				...
				<div class="features-box">
					...
					foreach($result as $row){
						?>
						<li>
						<img src="<?= $url_path ?><?php echo $row->photo;?>">
