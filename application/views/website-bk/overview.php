...
<section class="banner-sec">
	<img src="<?php echo $url_path ?><?= $row->photo; ?>" title="" alt="">
</section>
<!--End of banner  Part-->
<div class="clearfix"></div>
<div class="container-fluid cnt_fluid_wrapper">
	<div class="bread_block" id="bread_height_js">
		<div class="page_ttl_bread">Overview</div>
		<div class="page_menu_bread">
		<a href="<?php echo base_url(); ?>">Home</a><span class='bread_arrow'>&#8250;</span>Overview
		</div>			
	</div>
	<div class="mcontainer">
		...
		<div class="rsection wow fadeInRight animated animated">
			<ul>
				<li class="li_css">
					<a href="<?php echo base_url(); ?>overview">Overview</a>
				</li>
				<li class="li_css">
					<a href="<?php echo base_url(); ?>features">Features</a>
				</li>
				<li class="li_css">
					<a href="<?php echo base_url(); ?>floor_plan">Floor Plan</a>
				</li>
				<li class="li_css">
