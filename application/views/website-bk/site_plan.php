...
$banner = $this->Main_Model->get_website_data("site_plan_banner");
?>
...
<div class="container-fluid cnt_fluid_wrapper">
	<div class="bread_block" id="bread_height_js">
		<div class="page_ttl_bread">Site Plan</div>
		<div class="page_menu_bread">
		<a href="<?php echo base_url(); ?>">Home</a><span class='bread_arrow'>&#8250;</span>Site Plan
		</div>			
	</div>
			...
			<div class="msection-contant">
				<article id="post-162" class="post-162 page type-page status-publish hentry">
					...
					<div class="entry-content">
						<img src="<?php echo $url_path ?><?php echo $row->photo; ?>">
